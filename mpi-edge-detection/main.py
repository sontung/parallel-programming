...
def main():
    ...
    onlyfiles = ["%s/%s" % (mypath, f) for f in listdir(mypath) if isfile(join(mypath, f))]
    for i in onlyfiles:
        img = skimage.io.imread(i, as_grey=True)
...
if __name__ == '__main__':
    im = skimage.io.imread("/home/sontung/Downloads/blog/media/183442640043_0.jpg", as_grey=True)
    detect = cannyEdgeDetector(im)
    res = detect.detect()
